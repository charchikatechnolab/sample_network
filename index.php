            ...
            <div class="margin-general section_skin convert_section">
                ...
                <div class="display-flex convert_element">
                    ...
                    <div class="exchange_container">
                        <span class="no_selection" data-val="<?= $before_val2?>" data-reverse="<?=$rev_url?>" onclick="swap_unit();"><img
                                class="swap_image" src=<?= SYSTEM_IMAGES_PATH."/exchange.svg" ?> width="28" height="28"
                                alt="Exchange Units"></span>
                    </div>
                    <div class="pr">
                        <div class="convert_text">
